...
public class MiniCarouselAdapter extends RecyclerView.Adapter<MiniCarouselAdapter.GalleryViewHolder>{
    ...
    public MiniCarouselAdapter(RecyclerViewGalleryClickListener listener,Context context, ArrayList<RecyclerViewItem> listViewItem, String type) {
    ...
    public class GalleryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            listener.recyclerViewGalleryListClicked(view,uri.getText().toString());
        }
    }
    /**
